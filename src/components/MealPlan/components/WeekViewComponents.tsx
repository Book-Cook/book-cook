...
import { DAY_NAMES, HOUR_HEIGHT, HOURS, MIN_HOUR, TIME_COLUMN_WIDTH, formatHour } from "../WeekView/constants";
      ...
      {weekDates.map((date, index) => {
        ...
        return (
          <div
            ...
            className={clsx(styles.headerDay, isTodayDate && styles.todayHeader)}
            data-testid={isTodayDate ? "today-header" : "day-header"}
          >
            <Text className={clsx(styles.dayText, isTodayDate && styles.todayText)}>
    ...
    <div className={styles.timeColumn} data-testid="time-column">
      {HOURS.map(hour => (
        <div
          ...
          style={{ height: `${HOUR_HEIGHT}px`, top: `${(hour - MIN_HOUR) * HOUR_HEIGHT}px` }}
