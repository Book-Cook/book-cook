...
describe("ChangeSharedWithDialog", () => {
  ...
  it("renders with correct initial state", () => {
    ...
    expect(
      screen.getByLabelText("Private - Only you can view this recipe"),
    ).toBeInTheDocument();
  ...
  it("shows switch as checked when isPublic is true", () => {
    ...
    expect(
      screen.getByLabelText("Public - Anyone can view this recipe"),
    ).toBeInTheDocument();
    const switchElement = screen.getByRole("switch");
  ...
  it("resets state when isPublic prop changes", () => {
    ...
    rerender(<ChangeSharedWithDialog {...defaultProps} isPublic={true} />);
  ...
  it("does not render when isOpen is false", () => {
    ...
    expect(
      screen.queryByText("Toggle Recipe Visibility"),
