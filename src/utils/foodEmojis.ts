...
export const FOOD_EMOJIS = {
  ...
  // Desserts & Sweets
  "🍰": { name: "shortcake", category: "desserts" },
  "🧁": { name: "cupcake", category: "desserts" },
  "🎂": { name: "birthday cake", category: "desserts" },
  "🥮": { name: "moon cake", category: "desserts" },
  "🍪": { name: "cookie", category: "desserts" },
  ...
  // Beverages
  "☕": { name: "hot beverage coffee latte", category: "drinks" },
  ...
  "🥛": { name: "glass of milk", category: "drinks" },
  "🫗": { name: "pouring liquid", category: "drinks" },

  // Alcoholic Beverages
  "🍷": { name: "wine glass", category: "alcohol" },
  "🥂": { name: "clinking glasses", category: "alcohol" },
